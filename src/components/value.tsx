        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-10 px-[5%] mt-8 md:mt-16">
          <ScrollFadeIn>
            <div className="bg-white shadow-md border border-gray-200 p-7 flex flex-col gap-5 text-center justify-center items-center">
              ...
              <p className="text-sm md:text-[15px]">
                Whether {`you're`} preparing for a graduation, a corporate
                pitch, a wedding toast, or a keynote address, we can help you
                deliver speeches that captivate, inspire, and leave a lasting
                impression. Our team combines emotional intelligence, effective
                rhetorical techniques, and a keen awareness of your audience to
                create powerful speeches tailored to your unique voice and
                purpose.
              </p>
            </div>
          </ScrollFadeIn>
          ...
          <ScrollFadeIn>
            <div className="bg-white shadow-md border border-gray-200 p-7 flex flex-col gap-5 text-center justify-center items-center">
              ...
              <p className="text-sm md:text-[15px]">
                ...
                your writing, editing, and storytelling skills. Whether{" "}
                {`you're`} an aspiring author, student, or professional, we
                offer practical lessons, expert feedback, and real-world
                exercises to help you write with clarity, creativity, and
                confidence.
              </p>
            </div>
          </ScrollFadeIn>
          <ScrollFadeIn>
            <div className="bg-white shadow-md border border-gray-200 p-7 flex flex-col gap-5 text-center justify-center items-center">
              ...
              <p className="text-sm md:text-[15px]">
                We craft SEO-friendly, engaging, and audience-focused web
                content that helps you inform, sell, and connect. Whether{" "}
                {`it's`} landing pages, service descriptions, or blogs, our
                writing is tailored to boost visibility and drive user
                action—ensuring your website speaks your {`brand's`} voice
