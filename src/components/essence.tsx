...
export default function Essence() {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 bg-gray-100 gap-6 md:gap-10 px-[5%] mt-14 py-7 md:py-12">
        <div className="group bg-white p-5 border border-gray-200 flex flex-col gap-5 justify-center items-center shadow-md hover:bg-orange-600 transition-colors duration-300">
          ...
          <p className="text-gray-700 group-hover:text-white transition-colors duration-300 text-sm md:text[16px]">
            <span>
              To provide writing and editing services with distinction to local
          ...
          <div className="text-gray-700 group-hover:text-white transition-colors duration-300 flex flex-col gap-2.5 text-sm md:text[16px]">
            ...
            <li className="flex gap-2 list-none">
              ...
              <p>
                ...
                <br />
                <span>
                  Our writers and editors are ready to apply themselves and meet
                  your deadline
                </span>
              </p>
            </li>
