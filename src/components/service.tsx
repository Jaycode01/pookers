    ...
    <>
      <div className="py-10">
        <div className="relative w-full">
          <h1 className="absolute text-gray-300 text-[50px] -z-20">
            Our Services
          </h1>
          <h2 className="text-[40px] ml-24 pt-7">Our Services</h2>
        </div>
        <div className="px-[3%] flex flex-row justify-between mt-10 h-[770px]">
          <div className="w-1/2 flex flex-col gap-5">
            <div className="flex text-gray-700 flex-row gap-2.5  bg-white border border-gray-200 shadow-lg w-[90%] mx-auto p-5 rounded-lg hover:border-l-4 hover:border-orange-600 hover:border-t-0 hover:border-r-0 hover:border-b-0">
              <Brain size={35} />
              <div className="">
